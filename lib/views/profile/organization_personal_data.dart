...
class OrganizationPersonalDataPage extends StatefulWidget {
  // OrganizationPersonalDataPage(this.product);
  // final Product product;

  @override
  _OrganizationPersonalDataPageState createState() => _OrganizationPersonalDataPageState();
}

class _OrganizationPersonalDataPageState extends State<OrganizationPersonalDataPage> {
